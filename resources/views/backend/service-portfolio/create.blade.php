    ...
    <x-button-layout icon="fas fas fa-plus" :title="$page_title" btnText="Service Portfolio List" btnIcon="fas fa-list" :btnRoute="route('service-portfolio.index')" :permissions="['service-portfolio']">
        <x-form-post :action="route('service-portfolio.store')" :enctype="true">
            <div class="form-row">
                ...
                <x-form-group-input type="file" col="col-md-6" label="Before Photo" name="before_photo" :value="old('before_photo')" message="Image Size: (420X450)px"></x-form-group-input>
                <x-form-group-input type="file" col="col-md-6" label="After Photo" name="after_photo" :value="old('after_photo')" message="Image Size: (420X450)px"></x-form-group-input>
