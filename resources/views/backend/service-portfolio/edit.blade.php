            ...
            <div class="form-row">
                ...
                <div class="from-group col-md-6">
                    <div class="form-group">
                        ...
                        <img src="{{ $portfolio->getFirstMedia('service-portfolio-before')->getUrl('thumb') }}" alt="">
                    </div>
                </div>
                <div class="from-group col-md-6">
                    <div class="form-group">
                        <label for="photo">Previous After Photo:</label> <br>
                        <img src="{{ $portfolio->getFirstMedia('service-portfolio-after')->getUrl('thumb') }}" alt="">
                    </div>
                </div>
                <x-form-group-input type="file" col="col-md-6" label="Before Photo" :required="false" name="before_photo" message="Image Size: (420X450)px"></x-form-group-input>
                <x-form-group-input type="file" col="col-md-6" label="After Photo" :required="false" name="after_photo" message="Image Size: (420X450)px"></x-form-group-input>
