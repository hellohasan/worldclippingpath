...
(function($, window, document) {
    ...
    $(document).on('ready', function() {
        ...
        if ($('.wc-main-header li.dropdown ul').length) {
            $('.wc-main-header li.dropdown').append('<div class="dropdown-btn"><i class="icofont-simple-down"></i></div>');

            //Dropdown Button
            $('.wc-main-header li.dropdown .dropdown-btn').on('click', function() {
        ...
        if ($('.wc-mobile-menu').length) {
            ...
            var mobileMenuContent = $('.wc-main-header .nav-outer .wc-main-menu').html();
            $('.wc-mobile-menu .menu-box .menu-outer').append(mobileMenuContent);
            $('.wc-sticky-header .wc-main-menu').append(mobileMenuContent);


            //Menu Toggle Btn
            $('.wc-mobile-menu .menu-backdrop,.wc-mobile-menu .close-btn').on('click', function() {
                $('body').removeClass('wc-mobile-menu-visible');

            });
            //Dropdown Button
            $('.wc-mobile-menu li.dropdown .dropdown-btn').on('click', function() {
